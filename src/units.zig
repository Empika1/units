...
pub fn MakeUnitSystem(
    ...
    comptime return struct {
        ...
        fn MakeUnit(comptime scale_: Num, comptime shift_: Num, comptime quantity_: type) type {
            comptime {
                return struct {
                    ...
                    pub fn add(self: @This(), other: anytype) GetBaseUnit(@TypeOf(self)) {
                        return unitAdd(self, other);
                    }

                    pub fn subtract(self: @This(), other: anytype) GetBaseUnit(@TypeOf(self)) {
                        return unitSubtract(self, other);
                    }

                    pub fn multiply(self: @This(), other: anytype) QuantityMultiply(@TypeOf(self).quantity, @TypeOf(other).quantity).baseUnit {
                        return unitMultiply(self, other);
                    }

                    pub fn divide(self: @This(), other: anytype) QuantityDivide(@TypeOf(self).quantity, @TypeOf(other).quantity).baseUnit {
                        return unitDivide(self, other);
                    }

                    pub fn pow(self: @This(), comptime other: comptime_int) QuantityPow(@TypeOf(self).quantity, pow).baseUnit {
        ...
        pub fn MakeDerivedUnit(comptime Quantity: type, comptime scale_: Num, comptime shift_: Num) type {
            //assertQuantity(Quantity);
            comptime {
                return MakeUnit(scale_, shift_, Quantity);
            }
        }

        pub fn GetBaseUnit(comptime Unit: type) type {
            //assertUnit(Unit);
            comptime return Unit.quantity.baseUnit;
        }
        ...
        fn UnitMultiply(comptime a: type, comptime b: type) type {
            ...
            return MakeDerivedUnit(QuantityMultiply(a.quantity, b.quantity), a.scale * b.scale, 0);
        }
        ...
        fn UnitDivide(comptime a: type, comptime b: type) type {
            ...
            return MakeDerivedUnit(QuantityDivide(a.quantity, b.quantity), a.scale / b.scale, 0);
        }
        ...
        fn UnitPow(comptime a: type, comptime pow: comptime_int) type {
            ...
            return MakeDerivedUnit(QuantityPow(a.quantity, pow), numPow(a.scale, pow), 0);
        }
